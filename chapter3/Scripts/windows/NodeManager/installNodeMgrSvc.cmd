...
set SERVICE_DESCRIPTION="WebLogicNodeManager"
)

rem *** Install the service
"%WL_HOME%\server\bin\%WLSVC_EXE_TO_USE%" -install -svcname:"%PROD_NAME% NodeManager (%BAR_WL_HOME%)" -svcdescription:"%SERVICE_DESCRIPTION%" -javahome:"%JAVA_HOME%" -execdir:"%NODEMGR_HOME%" -extrapath:"%EXTRAPATH%" -cmdline:"%CMDLINE%" -log:"%NODEMGR_HOME%\%PROD_NAME%.out"
